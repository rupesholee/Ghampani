...
#  .g8"""bgd `7MMF'  `7MMF'      db      `7MMM.     ,MMF'`7MM"""Mq.   db      `7MN.   `7MF'`7MMF'
#.dP'     `M   MM      MM       ;MM:       MMMb    dPMM    MM   `MM. ;MM:       MMN.    M    MM  
#dM'       `   MM      MM      ,V^MM.      M YM   ,M MM    MM   ,M9 ,V^MM.      M YMb   M    MM  
#MM            MMmmmmmmMM     ,M  `MM      M  Mb  M' MM    MMmmdM9 ,M  `MM      M  `MN. M    MM  
#MM.    `7MMF' MM      MM     AbmmmqMA     M  YM.P'  MM    MM      AbmmmqMA     M   `MM.M    MM  
#`Mb.     MM   MM      MM    A'     VML    M  `YM'   MM    MM     A'     VML    M     YMM    MM  
#  `"bmmmdPY .JMML.  .JMML..AMA.   .AMMA..JML. `'  .JMML..JMML. .AMA.   .AMMA..JML.    YM  .JMML.
  
#By:- Rupesh Olee                                                                                                
# Ghampani banaune haina ta?? #
################################Hax Stroke#####################################
########################youtube.com/c/rupesholee################################
###########################Twitter: @myselfrupesh#################################
###################################GSH#########################################
##################https://www.facebook.com/kvo11/##################
...
BLACKHORIZON_BANNER = 'Ghampani Clound Based DDoS Tool MOdified By Rupesh Olee for Checking Server Capability'
...
class BlackHorizon(object):
    ...
    def fire(self):
        ...
        self.printHeader()
        print "Ghampani banaudai gareko awasta..Check if the website is down or not.".format(self.method, self.nr_clounds, self.nr_sockets)
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "#--------> Clounds Online: {0} Ghampani banaudai..... (Offline: {1}) Conection's online: {2} <--------#".format(self.counter[0], self.counter[1])
...
def usage():
    ...
    print 'Lets make it ghampani!!!!!!'
    print "\a"
print \
"""                                                       
"Ghampani banaune haina ta aba? 
  _______  __    __       ___      .___  ___. .______      ___      .__   __.  __  
 /  _____||  |  |  |     /   \     |   \/   | |   _  \    /   \     |  \ |  | |  | 
|  |  __  |  |__|  |    /  ^  \    |  \  /  | |  |_)  |  /  ^  \    |   \|  | |  | 
|  | |_ | |   __   |   /  /_\  \   |  |\/|  | |   ___/  /  /_\  \   |  . `  | |  | 
|  |__| | |  |  |  |  /  _____  \  |  |  |  | |  |     /  _____  \  |  |\   | |  | 
 \______| |__|  |__| /__/     \__\ |__|  |__| | _|    /__/     \__\ |__| \__| |__| 
...
if __name__ == "__main__":
    main()
#ckNMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
#.,cd0NMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
#.,,',:dOXWMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
#.,,,,,',:okXWMMMMMMMMMMMMMMMMMMMMMMMMMMM
#.,,,,,,,,',;lkKWMMMMMMMMMMMMMMMMMMMMMMMM
#.,,,,,,,,,,,'';lxKWMMMMMMMMMMMMMMMMMMMMM
#.,,,,,,,,,,,,,,,';cxk0NMMMMMMMMMMMMMMMMM
#.,,,,,;:clc;,,,,,,,'',cd0NWMMMMMMMMMMMMM
#.,:c;:d0XNXOo;;c:,,,,,,',:oOXWMMMMMMMMMM
#.,:dxkXWMMMWKxxo;,,,,,,,,,',:okXWMMMMMMM
#.,,:d0NWMMMWXOo;,,,,,,,,,,,,,',;lkKWMMMM
#.,,,;:ldxxxoc;,,,,,,,,,,,,,,,,,,'';cx0NM
#.,,,,,,,,,,,'.,:ccccccccccccccccccc:clxK
#.,,,,,,,,,,,,',o0NWWWWWWWWWWWWWWWWWWWWWW
#.,,,,;;,:c;;;;,';dKWMMMMMMMMMMMMMMMMMMMM
#.,,;,cxxOKkxd:,,,';dOKWMMMMMMMMMMMMMMMMM
#.,;cx0NWWWWWXOd:,,,'';dKWMMMMMMMMMMMMMMM
#.,:o0WMMMMMMMNOl;,,,,,';dKWMMMMMMMMMMMMM
#.,:o0WMMMMMMMNOl;,,,,,,,';dKWMMMMMMMMMMM
#.,;cx0NMMMMWXOd:,,,,,,,,,,';dKWMMMMMMMMM
#.,;;;lkk0KOOxc;;,,,,,,,,,,,,';dKWMMMMMMM
#.,,,,;;;:l;;;;,,,,,,,,,,,,,,,,';dKWMMMMM
#.,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,':dKWMMM
#.',,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,'';dXWM
#.....................................c0W
